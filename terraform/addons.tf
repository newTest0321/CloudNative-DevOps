...
module "eks_addons" {
  ...
  # Cluster information
  cluster_name      = module.book_app_eks.cluster_name
  cluster_endpoint  = module.book_app_eks.cluster_endpoint
  cluster_version   = module.book_app_eks.cluster_version
  oidc_provider_arn = module.book_app_eks.oidc_provider_arn
  ...
  depends_on = [module.book_app_eks]
}
